...
void TEST_F(IR_BlockDecoratedStructsTest, NoRootBlock) {
...
void TEST_F(IR_BlockDecoratedStructsTest, Scalar_Uniform) {
    auto* buffer =
...
void TEST_F(IR_BlockDecoratedStructsTest, Scalar_Storage) {
    auto* buffer =
...
void TEST_F(IR_BlockDecoratedStructsTest, RuntimeArray) {
...
void TEST_F(IR_BlockDecoratedStructsTest, RuntimeArray_InStruct) {
...
void TEST_F(IR_BlockDecoratedStructsTest, StructUsedElsewhere) {
    utils::Vector<const type::StructMember*, 4> members;
    members.Push(ty.Get<type::StructMember>(mod.symbols.New(), ty.i32(), 0u, 0u, 4u, 4u,
                                            type::StructMemberAttributes{}));
...
void TEST_F(IR_BlockDecoratedStructsTest, MultipleBuffers) {
    auto* buffer_a =
        b.Var(ty.pointer(ty.i32(), builtin::AddressSpace::kStorage, builtin::Access::kReadWrite));
    auto* buffer_b =
        b.Var(ty.pointer(ty.i32(), builtin::AddressSpace::kStorage, builtin::Access::kReadWrite));
